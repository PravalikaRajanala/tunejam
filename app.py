...
# Removed: from googleapiclient.discovery import build # No longer needed for Google Drive
...
# --- CONFIGURATION ---
# Removed: GOOGLE_DRIVE_API_KEY # No longer needed
# Removed: DRIVE_SERVICE # No longer needed
...
# Removed: @app.route('/proxy_googledrive_audio/<file_id>')
# Removed: @app.route('/search_googledrive_folder/<folder_id>')
# Removed: @app.route('/get_random_googledrive_songs/<folder_id>')
                    ...
                    if jam_data['host_sid'] == request.sid:
                        ...
                        if request.sid in jam_data['participants']:
                            ...
                            socketio.emit('update_participants', {
                                'jam_id': jam_id,
                                'participants': list(updated_participants.values()) # Send list of nicknames
                            }, room=jam_id)
                else:
...
def create_session(data):
    ...
    try:
        ...
        emit('session_created', {
            ...
            'participants': list(initial_jam_data['participants'].values()), # Send list of nicknames
...
if __name__ == '__main__':
    # Removed: GOOGLE_DRIVE_API_KEY warning
    if db is None:
